<div class="max-w-3xl">
    ...
    <form wire:submit="save" class="grid gap-5">
        {{-- brand --}}
        <div class="card p-5">
            <p class="mb-3 text-[0.62rem] font-bold uppercase tracking-wide text-muted">Brand</p>
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <label class="field-label !mb-1 !text-[0.62rem]">Company name</label>
                    ...
                    <div class="mt-2">
                        ...
                        <p class="mt-1 text-[0.6rem] text-muted">Logo — PNG, JPG, WebP or SVG.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- event defaults --}}
        <div class="card p-5">
            <p class="mb-3 text-[0.62rem] font-bold uppercase tracking-wide text-muted">Event defaults <span class="font-normal normal-case tracking-normal text-navy-300">— pre-fill every new event</span></p>
            <div class="grid gap-4 sm:grid-cols-3">
                <div>
                    <label class="field-label !mb-1 !text-[0.62rem]">Default currency</label>
                ...
                <div class="sm:col-span-2">
                    <label class="field-label !mb-1 !text-[0.62rem]">Default timezone</label>
                ...
                <div>
                    <label class="field-label !mb-1 !text-[0.62rem]">Country</label>
                    <input type="text" wire:model="country" class="input h-10 text-sm" placeholder="Jordan">
                </div>
                <div>
                    <label class="field-label !mb-1 !text-[0.62rem]">City / HQ</label>
        ...
        {{-- contact --}}
        <div class="card p-5">
            <p class="mb-3 text-[0.62rem] font-bold uppercase tracking-wide text-muted">Contact</p>
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    <label class="field-label !mb-1 !text-[0.62rem]">Address</label>
