@php
    ...
    $inp = 'w-full rounded-lg border border-transparent bg-transparent px-2 py-1 text-xs text-navy-900 placeholder:text-navy-300 hover:border-line focus:border-gold-400 focus:bg-white focus:outline-none';
