<div>
    ...
    <div id="s-manage" class="card scroll-mt-32 border-risk/20 p-6">
        ...
        @if ($showDelete && $inventory)
            <div class="mt-4 rounded-2xl border border-red-200 bg-red-50/50 p-4">
                ...
                @if ($inventory['money'])
                    <p class="mt-3 rounded-xl bg-red-100/70 px-3 py-2 text-[11.5px] font-bold text-red-900">
                ...
                <div class="mt-4 flex flex-wrap items-end gap-2">
                    ...
                    <button type="button" wire:click="destroyEvent"
                            ...
                            class="h-9 rounded-xl bg-red-600 px-4 text-xs font-bold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-40">
                        Delete this event
                    </button>
