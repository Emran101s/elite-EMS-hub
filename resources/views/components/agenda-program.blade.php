...
<div class="apg">
    <style>
        .apg{ --navy:#0B1F3A; --navy2:#16294A; --gold:#B08D2B; --gold-line:#E3CE8F; --gold-soft:#F6EFDC;
            --ink:#26313F; --muted:#6B7688; --line:#E7E3D6; --paper:#FBFAF6; --track:#F4F6FA; --trackline:#E2E7EF;
        ...
        .apg-head{ background:linear-gradient(135deg,var(--navy),var(--navy2)); color:#fff; border-radius:16px;
        ...
        .apg-sub{ font-size:12.5px; color:#C7D0DE; max-width:640px; line-height:1.55; position:relative; z-index:1; }
        .apg-legend{ display:flex; flex-wrap:wrap; gap:14px; margin-top:14px; position:relative; z-index:1; }
        .apg-legend span{ font-family:'Inter',system-ui,sans-serif; font-size:10px; font-weight:600; color:#C7D0DE;
            display:flex; align-items:center; gap:6px; }
        .apg-dot{ width:9px; height:9px; border-radius:3px; display:inline-block; }
        .apg-m{ background:var(--gold); } .apg-p{ background:#4E6D9C; } .apg-t{ background:#8A94A6; }
        .apg-n{ background:#5FA88C; } .apg-c{ background:#B06B6B; }
        ...
        .apg-card .apg-st{ color:#8A6A12; background:#F6E6B8; border-radius:4px; padding:1px 5px; white-space:nowrap; }
        @media (prefers-color-scheme:dark){ .apg-card .apg-st{ color:#F0D68A; background:#4A3C14; } }
        ...
        .apg-draft-tag{ font-size:9px; font-weight:800; letter-spacing:.16em; text-transform:uppercase;
            color:#fff; background:var(--gold); border-radius:4px; padding:2px 7px; white-space:nowrap; }
        ...
        .apg-card.apg-plen{ border-color:#C3D0E4; } .apg-card.apg-plen .apg-k{ color:#3F5C87; }
        .apg-card.apg-main{ flex:2 1 300px; background:linear-gradient(135deg,var(--gold-soft),#FBF6E7); border-color:var(--gold-line); }
        .apg-card.apg-main .apg-k{ color:var(--gold); } .apg-card.apg-main .apg-ti{ font-weight:700; }
        .apg-card.apg-net .apg-k{ color:#3F8368; }
        .apg-card.apg-cer{ border-color:#E3C7C7; } .apg-card.apg-cer .apg-k{ color:#9E5757; }
        ...
        .apg-pill{ font-family:'Inter',system-ui,sans-serif; font-size:9.5px; color:#4A5568; background:var(--paper);
