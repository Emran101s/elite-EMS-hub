...
{{-- Wrapped in .cx-canvas: this mounts inside .ehx-col-panel, which sits
     outside any canvas, and every --cx-* token is defined on .cx-canvas.
     Without the wrapper the panel's colours resolve to nothing — navy text
     on a navy head, an unfilled status pill. Padding is zeroed because the
