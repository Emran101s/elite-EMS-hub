    ...
    <div class="cx-modhero">
        <div class="cx-modhero-top">
            {{-- A light tint of the module's colour, not a transparent wash.
                 Overview's own colour IS the hero navy (#0B1F3A), so mixing it
                 toward transparent made the badge and its icon disappear into
                 the background entirely. Mixing toward white instead gives
                 every module a hex that reads on navy while keeping its own
                 hue, with the full-strength colour as the icon. --}}
