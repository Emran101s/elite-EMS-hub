...
<section class="rounded-[22px] border border-cc-line bg-white p-5 cc-lift-2">
    ...
    <ul class="mt-3 divide-y divide-cc-line">
        @foreach ($items as $s)
            ...
            <li>
                <a href="#" class="group flex items-start gap-3 py-3 transition hover:bg-cc-mist/50">
                    ...
                    <span class="flex shrink-0 flex-col items-end gap-1.5">
                        ...
                        <span class="grid h-6 w-6 place-items-center rounded-full bg-cc-navy text-[8.5px] font-bold text-cc-gold">EA</span>
                    </span>
                </a>
            </li>
        @endforeach
